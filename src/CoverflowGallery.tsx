...
// --- DEFINICIÓN MOVIDA ARRIBA PARA SOLUCIONAR ERROR DE HOISTING ---
const COMPONENT_DEFAULTS = {
    ...
    titleFont: {
        fontFamily: "Inter",
        fontWeight: "bold", // Corregido de 'variant' a 'fontWeight'
        fontSize: "28px",
...
export default function Smooth3DSlideshow(
    inputProps: Smooth3DSlideshowProps = COMPONENT_DEFAULTS
) {
    // Combinar propiedades de manera segura
    const props = {
        ...COMPONENT_DEFAULTS,
        ...inputProps,
        style: { ...(COMPONENT_DEFAULTS.style || {}), ...(inputProps.style || {}) },
        titleFont: { ...(COMPONENT_DEFAULTS.titleFont as CSSProperties), ...(inputProps.titleFont || {}) },
        titlePosition: {
            ...COMPONENT_DEFAULTS.titlePosition,
            ...(inputProps.titlePosition || {}),
        },
    } as Smooth3DSlideshowProps
