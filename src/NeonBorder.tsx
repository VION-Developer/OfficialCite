...
// Versión COMPLETA y corregida (con llave de cierre final)
...
// CORRECCIÓN DE TIPO: Acepta string | undefined para evitar errores de inicio
function withAlpha(input: string | undefined, alpha: number) {
